...
import com.xitij.tiktuk.Adapter.SoundsAdapter;
import com.xitij.tiktuk.Fragment.RelateFrags.RootFragment;
...
import com.xitij.tiktuk.POJO.sound.AddFavSoundData;
import com.xitij.tiktuk.POJO.sound.Sound;
import com.xitij.tiktuk.POJO.sound.SoundCategory;
        ...
        try {
            ...
            if(code.equals("200")){
                ...
                for(int i=msgArray.length()-1;i>=0;i--) {
                    ...
                    SoundCategory sound_catagory_get_set = new SoundCategory();
